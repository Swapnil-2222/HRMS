...
class AddressResourceIT {
    ...
    @Test
    @Transactional
    void getAllAddressesByAddress3IsEqualToSomething() throws Exception {
        // Initialize the database
        addressRepository.saveAndFlush(address);

        // Get all the addressList where address3 equals to DEFAULT_ADDRESS_3
        defaultAddressShouldBeFound("address3.equals=" + DEFAULT_ADDRESS_3);

        // Get all the addressList where address3 equals to UPDATED_ADDRESS_3
        defaultAddressShouldNotBeFound("address3.equals=" + UPDATED_ADDRESS_3);
    }

    @Test
    @Transactional
    void getAllAddressesByAddress3IsInShouldWork() throws Exception {
        // Initialize the database
        addressRepository.saveAndFlush(address);

        // Get all the addressList where address3 in DEFAULT_ADDRESS_3 or UPDATED_ADDRESS_3
        defaultAddressShouldBeFound("address3.in=" + DEFAULT_ADDRESS_3 + "," + UPDATED_ADDRESS_3);

        // Get all the addressList where address3 equals to UPDATED_ADDRESS_3
        defaultAddressShouldNotBeFound("address3.in=" + UPDATED_ADDRESS_3);
    }

    @Test
    @Transactional
    void getAllAddressesByAddress3IsNullOrNotNull() throws Exception {
        // Initialize the database
        addressRepository.saveAndFlush(address);

        // Get all the addressList where address3 is not null
        defaultAddressShouldBeFound("address3.specified=true");

        // Get all the addressList where address3 is null
        defaultAddressShouldNotBeFound("address3.specified=false");
    }

    @Test
    @Transactional
    void getAllAddressesByAddress3ContainsSomething() throws Exception {
        // Initialize the database
        addressRepository.saveAndFlush(address);

        // Get all the addressList where address3 contains DEFAULT_ADDRESS_3
        defaultAddressShouldBeFound("address3.contains=" + DEFAULT_ADDRESS_3);

        // Get all the addressList where address3 contains UPDATED_ADDRESS_3
        defaultAddressShouldNotBeFound("address3.contains=" + UPDATED_ADDRESS_3);
    }

    @Test
    @Transactional
    void getAllAddressesByAddress3NotContainsSomething() throws Exception {
        // Initialize the database
        addressRepository.saveAndFlush(address);

        // Get all the addressList where address3 does not contain DEFAULT_ADDRESS_3
        defaultAddressShouldNotBeFound("address3.doesNotContain=" + DEFAULT_ADDRESS_3);

        // Get all the addressList where address3 does not contain UPDATED_ADDRESS_3
        defaultAddressShouldBeFound("address3.doesNotContain=" + UPDATED_ADDRESS_3);
    }
