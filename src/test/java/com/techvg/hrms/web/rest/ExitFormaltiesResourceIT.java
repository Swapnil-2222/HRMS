...
class ExitFormaltiesResourceIT {
    ...
    private static final AnswersOptions DEFAULT_SECURITY = AnswersOptions.YES;
    private static final AnswersOptions UPDATED_SECURITY = AnswersOptions.NO;
    ...
    private static final AnswersOptions DEFAULT_EXIT_INTERVIEW = AnswersOptions.YES;
    private static final AnswersOptions UPDATED_EXIT_INTERVIEW = AnswersOptions.NO;

    private static final AnswersOptions DEFAULT_LIB_NO_DUE = AnswersOptions.YES;
    private static final AnswersOptions UPDATED_LIB_NO_DUE = AnswersOptions.NO;

    private static final AnswersOptions DEFAULT_NOTICE_PERIOD_SERVED = AnswersOptions.YES;
    private static final AnswersOptions UPDATED_NOTICE_PERIOD_SERVED = AnswersOptions.NO;

    private static final AnswersOptions DEFAULT_CLEARENCE = AnswersOptions.YES;
    private static final AnswersOptions UPDATED_CLEARENCE = AnswersOptions.NO;

    private static final AnswersOptions DEFAULT_ORG_ASSETS = AnswersOptions.YES;
    private static final AnswersOptions UPDATED_ORG_ASSETS = AnswersOptions.NO;

    private static final AnswersOptions DEFAULT_ORG_VEHICAL = AnswersOptions.YES;
    private static final AnswersOptions UPDATED_ORG_VEHICAL = AnswersOptions.NO;

    private static final AnswersOptions DEFAULT_RESIGN_LETTER = AnswersOptions.YES;
    private static final AnswersOptions UPDATED_RESIGN_LETTER = AnswersOptions.NO;
    ...
    private static final AnswersOptions DEFAULT_WORK_FOR_ORG = AnswersOptions.YES;
    private static final AnswersOptions UPDATED_WORK_FOR_ORG = AnswersOptions.NO;
