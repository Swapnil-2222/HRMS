...
public class ExitFormaltiesCriteria implements Serializable, Criteria {
    ...
    /**
     * Class for filtering AnswersOptions
     */
    public static class AnswersOptionsFilter extends Filter<AnswersOptions> {

        public AnswersOptionsFilter() {}

        public AnswersOptionsFilter(AnswersOptionsFilter filter) {
            super(filter);
        }

        @Override
        public AnswersOptionsFilter copy() {
            return new AnswersOptionsFilter(this);
        }
    }
    ...
    private AnswersOptionsFilter security;

    private StringFilter feedback;

    private InstantFilter exitDate;

    private AnswersOptionsFilter exitInterview;

    private AnswersOptionsFilter libNoDue;

    private AnswersOptionsFilter noticePeriodServed;

    private AnswersOptionsFilter clearence;

    private AnswersOptionsFilter orgAssets;

    private AnswersOptionsFilter orgVehical;

    private AnswersOptionsFilter resignLetter;

    private StringFilter shares;

    private StringFilter staffWelfare;

    private AnswersOptionsFilter workForOrg;
    ...
    public AnswersOptionsFilter getSecurity() {
        return security;
    }

    public AnswersOptionsFilter security() {
        if (security == null) {
            security = new AnswersOptionsFilter();
        }
        return security;
    }

    public void setSecurity(AnswersOptionsFilter security) {
    ...
    public AnswersOptionsFilter getExitInterview() {
        return exitInterview;
    }

    public AnswersOptionsFilter exitInterview() {
        if (exitInterview == null) {
            exitInterview = new AnswersOptionsFilter();
        }
        return exitInterview;
    }

    public void setExitInterview(AnswersOptionsFilter exitInterview) {
        this.exitInterview = exitInterview;
    }

    public AnswersOptionsFilter getLibNoDue() {
        return libNoDue;
    }

    public AnswersOptionsFilter libNoDue() {
        if (libNoDue == null) {
            libNoDue = new AnswersOptionsFilter();
        }
        return libNoDue;
    }

    public void setLibNoDue(AnswersOptionsFilter libNoDue) {
        this.libNoDue = libNoDue;
    }

    public AnswersOptionsFilter getNoticePeriodServed() {
        return noticePeriodServed;
    }

    public AnswersOptionsFilter noticePeriodServed() {
        if (noticePeriodServed == null) {
            noticePeriodServed = new AnswersOptionsFilter();
        }
        return noticePeriodServed;
    }

    public void setNoticePeriodServed(AnswersOptionsFilter noticePeriodServed) {
        this.noticePeriodServed = noticePeriodServed;
    }

    public AnswersOptionsFilter getClearence() {
        return clearence;
    }

    public AnswersOptionsFilter clearence() {
        if (clearence == null) {
            clearence = new AnswersOptionsFilter();
        }
        return clearence;
    }

    public void setClearence(AnswersOptionsFilter clearence) {
        this.clearence = clearence;
    }

    public AnswersOptionsFilter getOrgAssets() {
        return orgAssets;
    }

    public AnswersOptionsFilter orgAssets() {
        if (orgAssets == null) {
            orgAssets = new AnswersOptionsFilter();
        }
        return orgAssets;
    }

    public void setOrgAssets(AnswersOptionsFilter orgAssets) {
        this.orgAssets = orgAssets;
    }

    public AnswersOptionsFilter getOrgVehical() {
        return orgVehical;
    }

    public AnswersOptionsFilter orgVehical() {
        if (orgVehical == null) {
            orgVehical = new AnswersOptionsFilter();
        }
        return orgVehical;
    }

    public void setOrgVehical(AnswersOptionsFilter orgVehical) {
        this.orgVehical = orgVehical;
    }

    public AnswersOptionsFilter getResignLetter() {
        return resignLetter;
    }

    public AnswersOptionsFilter resignLetter() {
        if (resignLetter == null) {
            resignLetter = new AnswersOptionsFilter();
        }
        return resignLetter;
    }

    public void setResignLetter(AnswersOptionsFilter resignLetter) {
    ...
    public AnswersOptionsFilter getWorkForOrg() {
        return workForOrg;
    }

    public AnswersOptionsFilter workForOrg() {
        if (workForOrg == null) {
            workForOrg = new AnswersOptionsFilter();
        }
        return workForOrg;
    }

    public void setWorkForOrg(AnswersOptionsFilter workForOrg) {
